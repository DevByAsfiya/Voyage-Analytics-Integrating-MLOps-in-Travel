...
│   ├── hotels.csv                # Hotel recommendation  
│   └── gender_data.csv           # Gender classification
│
├── src/                           # Core ML modules
...
│   │   └── utils.py
│   │
│   ├── flight_price/             # Flight price prediction (Full MLOps)
│   │   ├── __init__.py
...
│   │   └── flight_price_mlflow_runner.py  # MLflow tracking
│   │
│   ├── gender_classification/    # Gender classifier (Streamlit)
│   │   ├── __init__.py
...
│   │   └── model_trainer.py
│   │
│   └── hotel_recommendation/     # Hotel recommender (Streamlit)
│       ├── __init__.py
│       ├── app.py                # Streamlit app
│       ├── data_ingestion.py
│       ├── data_transformation.py
...
│   │   ├── preprocessor.pkl
│   │   └── model.pkl
│   ├── gender_classification/    # Similar structure
│   └── hotel_recommendation/     # Similar structure
│
├── dags/                         # Airflow workflows (Flight only)
│   ├── flight_price_dag.py       # Daily retrain + deploy
│   ├── gender_dag.py
│   └── hotel_dag.py
│
...
│   └── docker-compose.yml
│
├── k8s/                          # Kubernetes manifests (Flight)
│   ├── Deployment.yml
│   └── Service.yml
│
...
│   └── index.html
│
├── Deployment.yml                # Main app deployment
├── Service.yml                   # Kubernetes service
├── Dockerfile                    # Streamlit API container
